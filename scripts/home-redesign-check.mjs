...
try {
  ...
  await tierRow.getByLabel('ภาพชั้นประกัน',{exact:true}).fill('assets/brand/home-tier-3-plus-v1.webp');
  await tierRow.getByRole('button',{name:'เลื่อนรายการลง',exact:true}).click();
