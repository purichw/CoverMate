...
try {
  ...
  await admin.close();
  for (const [url, file] of [['admin', 'admin/index.html'], ...['admin/ops/app.js', 'covermate-contract.js', 'covermate-public.mjs', 'covermate-submission.mjs', 'assets/brand/LINE_Brand_icon.png'].map(file => [file, file])]) {
