...
Generated: 2026-08-15T18:44:29.820Z
## Source Precedence
...
| `repo-defaults:sections.0.th.body` | mixed | public-section | sections.0.th.body | สำหรับประกันชีวิตและสุขภาพ เราให้บริการผ่าน AIA โดยตรง ส่วนประกันรถยนต์ เราเปรียบเทียบความคุ้มครองและเบี้ยประกันจากบริษัทประกันภัย 14 แห่ง เพื่อช่วยให้คุณเลือกความคุ้มครองที่เหมาะสม โดยไม่เสนอเกินความจำเป็น | Candidate for copy refinement. |
...
| `repo-defaults:sections.4.th.kicker` | th | public-section | sections.4.th.kicker | เครื่องมือและข้อมูลที่เป็นประโยชน์ | Candidate for copy refinement. |
| `repo-defaults:sections.4.th.title` | th | public-section | sections.4.th.title | ประเมินความต้องการ<br>คุ้มครองเบื้องต้น | Candidate for copy refinement. |
| `repo-defaults:sections.4.th.body` | th | public-section | sections.4.th.body | เครื่องมือนี้แยกการประเมินเป็นสามส่วน: ทุนชีวิตจากค่าใช้จ่ายจำเป็นและปีที่ครอบครัวต้องพึ่งพา, ส่วนต่างค่าห้องอ้างอิงจากข้อมูลโรงพยาบาลที่มีแหล่งที่มา, และเงินก้อนสำหรับช่วงพักฟื้นจากโรคร้ายแรง | Candidate for copy refinement. |
| `repo-defaults:sections.4.th.note` | mixed | public-section | sections.4.th.note | อ้างอิงชุดข้อมูล 2026-08-15-v0.1 และวิธีคำนวณที่แยกชีวิต สุขภาพ และโรคร้ายแรงออกจากกัน ตัวเลขเป็นจุดเริ่มต้นในการคุย ไม่ใช่ใบเสนอราคา คำแนะนำเฉพาะบุคคล หรือค่าใช้จ่ายที่ต้องจ่ายแน่นอน | Candidate for copy refinement. |
| `repo-defaults:sections.4.en.kicker` | en | public-section | sections.4.en.kicker | Tools and useful resources | Candidate for copy refinement. |
| `repo-defaults:sections.4.en.title` | en | public-section | sections.4.en.title | Estimate your<br>starting protection need | Candidate for copy refinement. |
| `repo-defaults:sections.4.en.body` | en | public-section | sections.4.en.body | This tool separates the estimate into three parts: life cover from essential spending and support years, a hospital room-gap reference with source provenance, and a recovery buffer for critical illness. | Candidate for copy refinement. |
| `repo-defaults:sections.4.en.note` | en | public-section | sections.4.en.note | Based on reference dataset 2026-08-15-v0.1 and methodology that keeps life, health and critical illness separate. The result is a discussion starting point, not a quotation, personalised advice, or a guaranteed out-of-pocket amount. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.datasetVersion` | en | public-section | sections.4.calculator.datasetVersion | 2026-08-15-v0.1 | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.sourcePackage` | en | public-section | sections.4.calculator.sourcePackage | covermate-reference-data-v0.1 | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.th` | th | public-section | sections.4.calculator.situations.start.th | เพิ่งเริ่มทำงาน | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.en` | en | public-section | sections.4.calculator.situations.start.en | Just started working | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.0.th` | th | public-section | sections.4.calculator.situations.start.recs.0.th | เริ่มจากค่ารักษาและอุบัติเหตุ | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.0.en` | en | public-section | sections.4.calculator.situations.start.recs.0.en | Start with health and accident cover | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.0.wth` | th | public-section | sections.4.calculator.situations.start.recs.0.wth | ช่วงเริ่มทำงานควรรักษาสภาพคล่องไว้ก่อน เครื่องมือนี้จึงแยกเงินก้อนชีวิตออกจากค่ารักษาและเงินพักฟื้น | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.0.wen` | en | public-section | sections.4.calculator.situations.start.recs.0.wen | Early-career planning should protect cash flow first, so this tool separates life need, medical room gap and recovery buffer. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.1.th` | th | public-section | sections.4.calculator.situations.start.recs.1.th | เพิ่มทุนชีวิตเมื่อมีคนพึ่งพารายได้ | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.1.en` | en | public-section | sections.4.calculator.situations.start.recs.1.en | Increase life cover when others depend on you | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.1.wth` | th | public-section | sections.4.calculator.situations.start.recs.1.wth | ทุนชีวิตควรอิงค่าใช้จ่ายจำเป็นและจำนวนปีที่ต้องดูแล ไม่ใช่ตัวคูณรายได้แบบตายตัว | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.1.wen` | en | public-section | sections.4.calculator.situations.start.recs.1.wen | Life cover should follow essential spending and support years, not a fixed salary multiplier. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.2.th` | th | public-section | sections.4.calculator.situations.start.recs.2.th | เช็กค่าห้องกับโรงพยาบาลที่ใช้จริง | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.2.en` | en | public-section | sections.4.calculator.situations.start.recs.2.en | Check room benefits against likely hospitals | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.2.wth` | th | public-section | sections.4.calculator.situations.start.recs.2.wth | ส่วนต่างค่าห้องเป็นข้อมูลอ้างอิง ไม่ใช่จำนวนเงินที่ต้องจ่ายแน่นอน เพราะขึ้นกับเงื่อนไขกรมธรรม์ | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.start.recs.2.wen` | en | public-section | sections.4.calculator.situations.start.recs.2.wen | The room gap is a reference, not a guaranteed bill, because policy terms decide the actual outcome. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.th` | th | public-section | sections.4.calculator.situations.family.th | มีครอบครัว มีลูก | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.en` | en | public-section | sections.4.calculator.situations.family.en | Family with kids | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.0.th` | th | public-section | sections.4.calculator.situations.family.recs.0.th | คุ้มครองรายจ่ายบ้านหลายปี | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.0.en` | en | public-section | sections.4.calculator.situations.family.recs.0.en | Protect household spending for several years | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.0.wth` | th | public-section | sections.4.calculator.situations.family.recs.0.wth | ใส่ค่าใช้จ่ายจำเป็นต่อเดือนและจำนวนปีที่อยากให้ครอบครัวยืนต่อได้ แล้วค่อยหักเงินสำรองหรือทุนเดิมที่กันไว้แล้ว | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.0.wen` | en | public-section | sections.4.calculator.situations.family.recs.0.wen | Enter essential monthly spending and the years your family needs support, then subtract liquid assets and existing cover. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.1.th` | th | public-section | sections.4.calculator.situations.family.recs.1.th | หนี้และค่าเรียนควรถูกนับแยก | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.1.en` | en | public-section | sections.4.calculator.situations.family.recs.1.en | Debts and education should be explicit | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.1.wth` | th | public-section | sections.4.calculator.situations.family.recs.1.wth | หนี้บ้าน รถ หรือภาระอนาคตควรเป็นตัวเลขแยกจากค่าใช้จ่ายรายเดือน เพื่อไม่ให้ทุนชีวิตต่ำกว่าภาระจริง | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.1.wen` | en | public-section | sections.4.calculator.situations.family.recs.1.wen | Mortgage, car debt and future obligations should be entered separately from monthly spending so life need is not understated. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.2.th` | th | public-section | sections.4.calculator.situations.family.recs.2.th | โรคร้ายแรงคือเงินพักฟื้น | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.2.en` | en | public-section | sections.4.calculator.situations.family.recs.2.en | Critical illness is a recovery buffer | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.2.wth` | th | public-section | sections.4.calculator.situations.family.recs.2.wth | เงินก้อนโรคร้ายแรงในเครื่องมือนี้อิงเดือนพักฟื้น ไม่ได้ผูกโรคใดโรคหนึ่งกับทุนตายตัว | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.family.recs.2.wen` | en | public-section | sections.4.calculator.situations.family.recs.2.wen | The CI figure is based on recovery months, not a disease-to-sum-insured shortcut. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.th` | th | public-section | sections.4.calculator.situations.business.th | เจ้าของธุรกิจ | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.en` | en | public-section | sections.4.calculator.situations.business.en | Business owner | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.0.th` | th | public-section | sections.4.calculator.situations.business.recs.0.th | แยกภาระบ้านกับภาระธุรกิจ | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.0.en` | en | public-section | sections.4.calculator.situations.business.recs.0.en | Separate household and business obligations | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.0.wth` | th | public-section | sections.4.calculator.situations.business.recs.0.wth | ภาระธุรกิจที่ครอบครัวต้องรับต่อควรถูกใส่เป็นภาระอนาคต ไม่รวมปนกับค่าใช้จ่ายประจำบ้าน | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.0.wen` | en | public-section | sections.4.calculator.situations.business.recs.0.wen | Business obligations that would fall to the family should be added as future obligations, not blended into household spending. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.1.th` | th | public-section | sections.4.calculator.situations.business.recs.1.th | เงินสดสำรองช่วยลดช่องว่างได้ | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.1.en` | en | public-section | sections.4.calculator.situations.business.recs.1.en | Earmarked liquidity reduces the gap | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.1.wth` | th | public-section | sections.4.calculator.situations.business.recs.1.wth | เงินสำรองที่ตั้งใจใช้เพื่อครอบครัวหรือธุรกิจในกรณีฉุกเฉินสามารถนำมาหักได้ แต่เงินทุนหมุนเวียนที่ต้องใช้ทำงานไม่ควรนับซ้ำ | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.1.wen` | en | public-section | sections.4.calculator.situations.business.recs.1.wen | Earmarked emergency liquidity can reduce the gap, but working capital needed by the business should not be double-counted. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.2.th` | th | public-section | sections.4.calculator.situations.business.recs.2.th | ตรวจ health limit แยกจากทุนชีวิต | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.2.en` | en | public-section | sections.4.calculator.situations.business.recs.2.en | Review health limits separately from life cover | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.2.wth` | mixed | public-section | sections.4.calculator.situations.business.recs.2.wth | ค่ารักษาไม่ควรถูกนำไปคูณเป็นทุนชีวิต แต่ควรตรวจเป็น room gap และเงื่อนไขกรมธรรม์แยกต่างหาก | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.business.recs.2.wen` | en | public-section | sections.4.calculator.situations.business.recs.2.wen | Medical costs should not drive life cover. Review room gap and policy wording separately. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.th` | th | public-section | sections.4.calculator.situations.retire.th | ใกล้เกษียณ | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.en` | en | public-section | sections.4.calculator.situations.retire.en | Near retirement | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.0.th` | th | public-section | sections.4.calculator.situations.retire.recs.0.th | ลดทุนชีวิตเมื่อภาระลดลง | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.0.en` | en | public-section | sections.4.calculator.situations.retire.recs.0.en | Reduce life cover as obligations fall | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.0.wth` | th | public-section | sections.4.calculator.situations.retire.recs.0.wth | ถ้าหนี้และคนพึ่งพิงลดลง ทุนชีวิตอาจไม่ต้องสูงเท่าช่วงสร้างครอบครัว แต่สุขภาพและเงินพักฟื้นยังควรตรวจละเอียด | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.0.wen` | en | public-section | sections.4.calculator.situations.retire.recs.0.wen | As debts and dependants fall, life cover may not need to be as high as before, while health and recovery buffers deserve closer review. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.1.th` | th | public-section | sections.4.calculator.situations.retire.recs.1.th | ค่าห้องควรตรงกับโรงพยาบาลที่ใช้จริง | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.1.en` | en | public-section | sections.4.calculator.situations.retire.recs.1.en | Room benefits should match likely hospitals | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.1.wth` | th | public-section | sections.4.calculator.situations.retire.recs.1.wth | เลือกค่าห้องจากโรงพยาบาลที่มีแนวโน้มใช้จริง แล้วดูว่าส่วนต่างที่ต้องเตรียมรับได้หรือไม่ | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.1.wen` | en | public-section | sections.4.calculator.situations.retire.recs.1.wen | Choose a likely hospital reference and check whether the resulting room gap is acceptable. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.2.th` | th | public-section | sections.4.calculator.situations.retire.recs.2.th | กันเงินพักฟื้นที่ไม่ใช่ค่ารักษา | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.2.en` | en | public-section | sections.4.calculator.situations.retire.recs.2.en | Set aside non-medical recovery cash | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.2.wth` | th | public-section | sections.4.calculator.situations.retire.recs.2.wth | ช่วงพักฟื้นยังมีค่าเดินทาง คนดูแล และรายได้ที่อาจลดลง ซึ่งไม่ใช่ค่ารักษาโดยตรง | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.situations.retire.recs.2.wen` | en | public-section | sections.4.calculator.situations.retire.recs.2.wen | Recovery may require transport, caregiving and income replacement beyond hospital bills. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.life.formula` | en | public-section | sections.4.calculator.life.formula | essential_monthly_household_spending * 12 * support_years + outstanding_debts + future_obligations + transition_final_costs - earmarked_liquid_assets - existing_death_benefits | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.life.guardrails.0` | en | public-section | sections.4.calculator.life.guardrails.0 | Do not use hospital treatment costs in the core life-sum calculation. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.life.guardrails.1` | en | public-section | sections.4.calculator.life.guardrails.1 | Do not use arbitrary salary multipliers as the authoritative model. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.life.guardrails.2` | en | public-section | sections.4.calculator.life.guardrails.2 | Willingness to pay must not reduce calculated need. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.model` | en | public-section | sections.4.calculator.health.model | coverage_fit_and_out_of_pocket_reference | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.hospitalId` | en | public-section | sections.4.calculator.health.selectedRoomReference.hospitalId | bnh | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.hospitalName.th` | th | public-section | sections.4.calculator.health.selectedRoomReference.hospitalName.th | โรงพยาบาล BNH | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.hospitalName.en` | en | public-section | sections.4.calculator.health.selectedRoomReference.hospitalName.en | BNH Hospital | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.roomType.th` | th | public-section | sections.4.calculator.health.selectedRoomReference.roomType.th | Regent Adult | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.roomType.en` | en | public-section | sections.4.calculator.health.selectedRoomReference.roomType.en | Regent Adult | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.currency` | en | public-section | sections.4.calculator.health.selectedRoomReference.currency | THB | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.priceUnit` | en | public-section | sections.4.calculator.health.selectedRoomReference.priceUnit | day | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.confidenceLevel` | en | public-section | sections.4.calculator.health.selectedRoomReference.confidenceLevel | A | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.note.th` | th | public-section | sections.4.calculator.health.selectedRoomReference.note.th | ข้อมูลค่าห้องอ้างอิงจากหน้าโรงพยาบาล ไม่ใช่จำนวนเงินที่ผู้เอาประกันต้องจ่ายแน่นอน | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.selectedRoomReference.note.en` | en | public-section | sections.4.calculator.health.selectedRoomReference.note.en | Published room reference from the hospital page, not a guaranteed out-of-pocket amount. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.guardrails.0` | en | public-section | sections.4.calculator.health.guardrails.0 | Do not output one authoritative required sum insured. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.guardrails.1` | en | public-section | sections.4.calculator.health.guardrails.1 | Do not call the reference difference the amount the user will definitely pay. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.guardrails.2` | en | public-section | sections.4.calculator.health.guardrails.2 | Every medical reference must expose source, last_checked and confidence. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.health.guardrails.3` | en | public-section | sections.4.calculator.health.guardrails.3 | Do not derive P50/P75/P90 from promotional/package pages. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.criticalIllness.formula` | en | public-section | sections.4.calculator.criticalIllness.formula | essential_monthly_spending * recovery_months + one_off_recovery_non_medical_budget + chosen_medical_oop_buffer - earmarked_emergency_assets - existing_ci_lump_sum_cover | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.criticalIllness.guardrails.0` | en | public-section | sections.4.calculator.criticalIllness.guardrails.0 | Recovery period must be explicitly user-selected. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.criticalIllness.guardrails.1` | en | public-section | sections.4.calculator.criticalIllness.guardrails.1 | Do not map a disease name to a fixed CI sum. | Candidate for copy refinement. |
| `repo-defaults:sections.4.calculator.criticalIllness.guardrails.2` | en | public-section | sections.4.calculator.criticalIllness.guardrails.2 | Health treatment scenarios may contextualize the user's chosen medical OOP buffer but must not dictate it. | Candidate for copy refinement. |
| `repo-defaults:sections.5.th.kicker` | th | public-section | sections.5.th.kicker | ทำงานกันอย่างไร | Candidate for copy refinement. |
| `repo-defaults:sections.5.th.title` | th | public-section | sections.5.th.title | ขั้นตอน<br>การทำงานร่วมกัน | Candidate for copy refinement. |
| `repo-defaults:sections.5.en.kicker` | en | public-section | sections.5.en.kicker | How it works | Candidate for copy refinement. |
| `repo-defaults:sections.5.en.title` | en | public-section | sections.5.en.title | How we<br>work together | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.0.th.title` | mixed | public-section | sections.5.items.0.th.title | ติดต่อทาง LINE | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.0.th.body` | th | public-section | sections.5.items.0.th.body | ส่งคำถามที่ต้องการทราบมาได้เลย ไม่ต้องเตรียมเอกสาร และไม่มีข้อผูกมัดในการดำเนินการต่อ | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.0.en.title` | en | public-section | sections.5.items.0.en.title | Contact us on LINE | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.0.en.body` | en | public-section | sections.5.items.0.en.body | Send us the question you would like to discuss. There is nothing to prepare and no obligation to proceed. | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.1.th.title` | th | public-section | sections.5.items.1.th.title | พูดคุยเบื้องต้น | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.1.th.body` | th | public-section | sections.5.items.1.th.body | พูดคุยเรื่องรายได้ ภาระ และสิ่งที่คุณให้ความสำคัญ เพื่อประเมินระดับความคุ้มครองที่เหมาะสม | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.1.en.title` | en | public-section | sections.5.items.1.en.title | Initial consultation | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.1.en.body` | en | public-section | sections.5.items.1.en.body | We discuss your income, obligations and priorities to understand what level of cover may be appropriate. | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.2.th.title` | th | public-section | sections.5.items.2.th.title | เปรียบเทียบทางเลือก | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.2.th.body` | th | public-section | sections.5.items.2.th.body | เราจัดทำข้อมูลเปรียบเทียบ พร้อมอธิบายความแตกต่างของความคุ้มครอง เบี้ยประกัน และเงื่อนไขสำคัญ | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.2.en.title` | en | public-section | sections.5.items.2.en.title | Compare the options | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.2.en.body` | en | public-section | sections.5.items.2.en.body | We prepare a clear comparison and explain the differences in cover, premium and key conditions. | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.3.th.title` | th | public-section | sections.5.items.3.th.title | ดูแลต่อเนื่อง | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.3.th.body` | th | public-section | sections.5.items.3.th.body | เราช่วยประสานงานเรื่องการต่ออายุ การแก้ไขกรมธรรม์ และการเคลมกับบริษัทประกันภัยอย่างต่อเนื่อง | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.3.en.title` | en | public-section | sections.5.items.3.en.title | Ongoing service | Candidate for copy refinement. |
| `repo-defaults:sections.5.items.3.en.body` | en | public-section | sections.5.items.3.en.body | We assist with renewals, policy changes and claim coordination throughout the policy term. | Candidate for copy refinement. |
| `repo-defaults:sections.6.th.kicker` | th | public-section | sections.6.th.kicker | ประกันรถยนต์ · ในฐานะนายหน้า | Candidate for copy refinement. |
| `repo-defaults:sections.6.th.title` | th | public-section | sections.6.th.title | ประกันรถยนต์<br>เปรียบเทียบได้ 14 แห่ง | Candidate for copy refinement. |
| `repo-defaults:sections.6.th.body` | mixed | public-section | sections.6.th.body | สำหรับประกันรถยนต์ เราสามารถเปรียบเทียบข้อเสนอจากบริษัทประกันภัย 14 แห่ง เพื่อพิจารณาทางเลือกที่เหมาะสมกับคุณ ส่วนประกันชีวิตและสุขภาพดำเนินการผ่าน AIA | Candidate for copy refinement. |
| `repo-defaults:sections.6.en.kicker` | en | public-section | sections.6.en.kicker | Motor insurance · as a broker | Candidate for copy refinement. |
| `repo-defaults:sections.6.en.title` | en | public-section | sections.6.en.title | Motor insurance<br>compared across 14 insurers | Candidate for copy refinement. |
| `repo-defaults:sections.6.en.body` | en | public-section | sections.6.en.body | For motor insurance, we compare options from 14 insurers. Life and health insurance is arranged through AIA. | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.0.th.name` | th | public-section | sections.6.items.0.th.name | วิริยะประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.0.en.name` | en | public-section | sections.6.items.0.en.name | Viriyah | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.1.th.name` | th | public-section | sections.6.items.1.th.name | กรุงเทพประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.1.en.name` | en | public-section | sections.6.items.1.en.name | Bangkok Insurance | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.2.th.name` | th | public-section | sections.6.items.2.th.name | โตเกียวมารีนประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.2.en.name` | en | public-section | sections.6.items.2.en.name | Tokio Marine | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.3.th.name` | th | public-section | sections.6.items.3.th.name | อลิอันซ์ อยุธยา | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.3.en.name` | en | public-section | sections.6.items.3.en.name | Allianz Ayudhya | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.4.th.name` | th | public-section | sections.6.items.4.th.name | เทเวศประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.4.en.name` | en | public-section | sections.6.items.4.en.name | Deves | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.5.th.name` | th | public-section | sections.6.items.5.th.name | เมืองไทยประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.5.en.name` | en | public-section | sections.6.items.5.en.name | Muang Thai | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.6.th.name` | th | public-section | sections.6.items.6.th.name | ธนชาตประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.6.en.name` | en | public-section | sections.6.items.6.en.name | Thanachart | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.7.th.name` | th | public-section | sections.6.items.7.th.name | ทิพยประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.7.en.name` | en | public-section | sections.6.items.7.en.name | Dhipaya | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.8.th.name` | th | public-section | sections.6.items.8.th.name | ชับบ์สามัคคีประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.8.en.name` | en | public-section | sections.6.items.8.en.name | Chubb Samaggi | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.9.th.name` | th | public-section | sections.6.items.9.th.name | แอกซ่าประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.9.en.name` | en | public-section | sections.6.items.9.en.name | AXA | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.10.th.name` | mixed | public-section | sections.6.items.10.th.name | MSIG ประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.10.en.name` | en | public-section | sections.6.items.10.en.name | MSIG | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.11.th.name` | th | public-section | sections.6.items.11.th.name | นวกิจประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.11.en.name` | en | public-section | sections.6.items.11.en.name | Navakij | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.12.th.name` | th | public-section | sections.6.items.12.th.name | ไทยวิวัฒน์ประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.12.en.name` | en | public-section | sections.6.items.12.en.name | Thaivivat | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.13.th.name` | th | public-section | sections.6.items.13.th.name | ซมโปะประกันภัย | Candidate for copy refinement. |
| `repo-defaults:sections.6.items.13.en.name` | en | public-section | sections.6.items.13.en.name | Sompo | Candidate for copy refinement. |
| `repo-defaults:sections.6.cards.0.th.kicker` | th | public-section | sections.6.cards.0.th.kicker | ประกันชีวิต+สุขภาพ · ในฐานะตัวแทน | Candidate for copy refinement. |
| `repo-defaults:sections.6.cards.0.th.title` | mixed | public-section | sections.6.cards.0.th.title | ตัวแทน AIA อย่างเป็นทางการ | Candidate for copy refinement. |
| `repo-defaults:sections.6.cards.0.en.kicker` | en | public-section | sections.6.cards.0.en.kicker | Life & health · as an agent | Candidate for copy refinement. |
| `repo-defaults:sections.6.cards.0.en.title` | en | public-section | sections.6.cards.0.en.title | Official AIA agent | Candidate for copy refinement. |
| `repo-defaults:sections.6.cards.1.th.kicker` | th | public-section | sections.6.cards.1.th.kicker | ประกันรถยนต์ · ในฐานะนายหน้า | Candidate for copy refinement. |
| `repo-defaults:sections.6.cards.1.th.title` | mixed | public-section | sections.6.cards.1.th.title | ศรีกรุงโบรคเกอร์ · Srikrung Broker | Candidate for copy refinement. |
| `repo-defaults:sections.6.cards.1.en.kicker` | en | public-section | sections.6.cards.1.en.kicker | Motor cover · as a broker | Candidate for copy refinement. |
| `repo-defaults:sections.6.cards.1.en.title` | mixed | public-section | sections.6.cards.1.en.title | ศรีกรุงโบรคเกอร์ · Srikrung Broker | Candidate for copy refinement. |
...
| `repo-defaults:sections.12.th.body` | mixed | public-section | sections.12.th.body | CoverMate เกิดขึ้นจากการเห็นว่าหลายคนเพิ่งพบในวันที่ต้องใช้สิทธิหรือเคลมว่า ความคุ้มครองที่มีไม่ตรงกับสิ่งที่เข้าใจไว้ เราจึงให้ความสำคัญกับการอธิบายทางเลือก เงื่อนไข และข้อจำกัดให้ชัดเจน เพื่อให้คุณมีข้อมูลเพียงพอก่อนตัดสินใจ<br><br>สำหรับประกันชีวิตและสุขภาพ เราให้บริการผ่าน AIA ส่วนประกันรถยนต์ให้บริการในฐานะนายหน้า โดยเปรียบเทียบทางเลือกจากบริษัทประกันภัยตามความเหมาะสม | Candidate for copy refinement. |
...
| `repo-defaults:sections.6.cards.0.th.body` | mixed | public-section | sections.6.cards.0.th.body | ใบอนุญาตตัวแทนประกันชีวิตเลขที่ 6401006221 · ประกันชีวิตและสุขภาพ เราดูแลในฐานะตัวแทน AIA โดยตรง กรมธรรม์ออกโดย AIA | Do not change licence numbers, legal assertions, or compliance meaning without owner/legal approval. |
| `repo-defaults:sections.6.cards.0.en.body` | en | public-section | sections.6.cards.0.en.body | Life agent licence No. 6401006221 · Life and health insurance is handled directly as an AIA agent. Policies are issued by AIA. | Do not change licence numbers, legal assertions, or compliance meaning without owner/legal approval. |
| `repo-defaults:sections.6.cards.1.th.body` | th | public-section | sections.6.cards.1.th.body | ใบอนุญาตนายหน้าประกันวินาศภัยเลขที่ ว00287/2534 · เราเสนอและจัดเบี้ยประกันรถยนต์ในฐานะนายหน้าภายใต้ศรีกรุงโบรคเกอร์ กรมธรรม์ออกโดยบริษัทประกันที่คุณเลือก | Do not change licence numbers, legal assertions, or compliance meaning without owner/legal approval. |
| `repo-defaults:sections.6.cards.1.en.body` | mixed | public-section | sections.6.cards.1.en.body | Non-life broker licence No. ว00287/2534 · Motor insurance is proposed and placed in a broker capacity under Srikrung Broker. Policies are issued by the insurer you choose. | Do not change licence numbers, legal assertions, or compliance meaning without owner/legal approval. |
