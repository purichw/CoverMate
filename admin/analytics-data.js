...
const QUERY_LABELS = {
  quote: "ขอใบเสนอราคา / เปรียบเทียบแผน",
  assess: "ประเมินความคุ้มครองที่เหมาะสม",
  compare: "เปรียบเทียบแผน",
  general: "คำถามทั่วไป / เรื่องอื่น ๆ",
  review: "ตรวจ / ทบทวนกรมธรรม์ที่มีอยู่",
  renewal: "ต่ออายุประกัน",
  service: "บริการหลังการขาย / แก้ไขกรมธรรม์",
  claim: "สอบถาม / ขอความช่วยเหลือเรื่องเคลม",
  "": "ไม่ระบุ"
};
