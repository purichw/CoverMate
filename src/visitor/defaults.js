const DEFAULTS = {
  "brand": {
    ...
    "advisorLogo": "assets/logos/aia-logo.png",
    "advisorLogoAlt": "AIA"
  },
  "seo": {
    "title": {
  ...
  "sections": [
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          "icon": "seal",
          "th": {
            "label": "ประกันชีวิตและสุขภาพผ่าน AIA"
          },
          "en": {
            "label": "AIA life and health cover"
          }
        },
        {
          "icon": "zap",
        ...
        },
        {
          "icon": "shield",
          "th": {
            "label": "ดูแลต่อเนื่องถึงการเคลม"
          },
          "en": {
            "label": "Support through claims"
          }
        }
      ]
    },
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "logo": "assets/ins/02-bangkok.png",
          "th": {
        ...
        {
          "logo": "assets/ins/03-tokio-marine.png",
          "th": {
        ...
        {
          "logo": "assets/ins/04-allianz.png",
          "th": {
        ...
        {
          "logo": "assets/ins/06-muang-thai.png",
          "th": {
        ...
        {
          "logo": "assets/ins/07-thanachart.png",
          "th": {
            "name": "ธนชาตประกันภัย"
          },
          "en": {
        ...
        {
          "logo": "assets/ins/08-dhipaya.png",
          "th": {
            "name": "ทิพยประกันภัย"
          },
          "en": {
        ...
        {
          "logo": "assets/ins/09-chubb.png",
          "th": {
            "name": "ชับบ์สามัคคีประกันภัย"
          },
          "en": {
            "name": "Chubb Samaggi"
          }
        ...
        {
          "logo": "assets/ins/10-axa.png",
          "th": {
            "name": "แอกซ่าประกันภัย"
          },
          "en": {
            "name": "AXA"
          }
        ...
        {
          "logo": "assets/ins/12-navakij.png",
          "th": {
            "name": "นวกิจประกันภัย"
          },
          "en": {
      ...
      "cards": [
        {
          "logo": "assets/logos/aia-logo.png",
          "logoAlt": "AIA",
          "logoH": 38,
          "logoMaxW": 112,
          "th": {
        ...
        {
          "logo": "assets/logos/srikrung-logo.png",
          "logoAlt": "Srikrung Broker",
          "logoH": 34,
          "logoMaxW": 132,
          "th": {
            "kicker": "ประกันรถยนต์ · ในฐานะนายหน้า",
    ...
    },
    {
      ...
      "heads": [
        {
          "th": "คุ้มครองรถของผู้เอาประกัน",
          "en": "Your own car"
        },
        {
          "th": "คุ้มครองคู่กรณี (ชีวิต/ทรัพย์สิน)",
          "en": "Third party (injury / property)"
        },
        {
          "th": "คุ้มครองอุบัติเหตุส่วนบุคคล",
        ...
        {
          "th": "คุ้มครองภัยธรรมชาติ",
          "en": "Flood & natural disaster"
        }
      ],
      "items": [
        {
      ...
      "items": [
        {
          ...
          "th": {
            "title": "ดูคนก่อนดูรถ",
            "body": "มีใครเจ็บไหม ถ้าเจ็บโทร 1669 ทันที ย้ายรถออกจากช่องทางเดินรถถ้าขยับได้ เปิดไฟฉุกเฉิน ตั้งสามเหลี่ยม อย่ายืนอยู่บนถนน"
          },
          "en": {
            "title": "People before cars",
            "body": "Anyone hurt? Call 1669 immediately. Move the car out of live traffic if it can be moved, turn hazards on, set a warning triangle and avoid standing in the road."
          }
        },
        {
          "icon": "camera",
          "th": {
            "title": "ถ่ายรูปก่อนขยับ",
            "body": "ถ่ายให้เห็นตำแหน่งรถทั้งสองคันพร้อมกัน ป้ายทะเบียนคู่กรณี ความเสียหายทุกด้าน และภาพกว้างให้เห็นถนนกับสัญญาณไฟ"
          },
          "en": {
            "title": "Photograph before moving",
            "body": "Take photos showing both vehicles in position, the other plate, all visible damage, and a wide view of the road and traffic signals."
          }
        },
        {
          "icon": "phone",
          "th": {
            "title": "แจ้งบริษัทประกัน",
            "body": "โทรสายด่วนบริษัทที่หน้ากรมธรรม์ แจ้งเลขกรมธรรม์กับสถานที่ รอเจ้าหน้าที่มาออกใบเคลม อย่าตกลงจ่ายเงินสดกันเองข้างถนน"
          },
          "en": {
            "title": "Notify the insurer",
            "body": "Call the hotline shown on your policy with the policy number and location, then wait for the surveyor or claim slip. Avoid settling in cash at the roadside."
          }
        },
        {
          "icon": "chat",
      ...
      "cards": [
        {
          "th": {
            "kicker": "เจ็บ · ฉุกเฉิน",
            "title": "1669",
            "body": "ศูนย์การแพทย์ฉุกเฉิน · ฟรี ตลอด 24 ชม."
          },
          "en": {
            "kicker": "Injury · emergency",
            "title": "1669",
            "body": "Emergency medical services · free, 24 hours"
          }
        },
        {
          "th": {
            "kicker": "ตำรวจ",
            "title": "191",
            "body": "เมื่อมีข้อพิพาท คู่กรณีหนี หรือต้องลงบันทึกประจำวัน"
          },
          "en": {
            "kicker": "Police",
            "title": "191",
            "body": "For disputes, a driver leaving the scene, or a police report"
          }
        },
        {
          "th": {
            "kicker": "อุบัติเหตุบนทางหลวง",
            "title": "1586",
            "body": "สายด่วนกรมทางหลวง · แจ้งเหตุและขอความช่วยเหลือบนถนน"
          },
          "en": {
            "kicker": "Highway incidents",
            "title": "1586",
            "body": "Department of Highways hotline · road incidents and assistance"
          }
        },
        {
          "th": {
            "kicker": "ร้องเรียนเรื่องประกัน",
            "title": "1186",
            "body": "สายด่วน คปภ. · เมื่อบริษัทประกันปฏิเสธหรือประวิงเวลา"
          },
          "en": {
            "kicker": "Insurance complaints",
            "title": "1186",
            "body": "OIC hotline · when an insurer refuses or delays"
          }
        }
      ]
    },
      ...
      "items": [
        {
          "th": {
            "label": "ความเชี่ยวชาญ",
            "value": "ชีวิต สุขภาพ และรถยนต์"
          },
          "en": {
            "label": "Focus",
            "value": "Life, health and motor"
          }
        },
        {
          "th": {
            "label": "ใบอนุญาต",
            "value": "ตัวแทนประกันชีวิต 6401006221 · นายหน้าประกันวินาศภัย 6804008544"
          },
          "en": {
            "label": "Licences",
            "value": "Life agent No. 6401006221 · Non-life broker No. 6804008544"
          }
        },
        {
          "th": {
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "th": {
            "label": "เก็บนานเท่าไหร่",
            "value": "ถ้าไม่ได้ทำกรมธรรม์ ลบภายใน 12 เดือน ถ้าทำแล้ว เก็บตามอายุกรมธรรม์บวก 10 ปีตามที่กฎหมายประกันภัยกำหนด"
          },
          "en": {
            "label": "How long it is kept",
            "value": "If nothing is arranged, deleted within 12 months. If a policy is issued, kept for its term plus the 10 years insurance law requires."
          }
        },
        {
          "th": {
            "label": "สิทธิของคุณ",
            "value": "ขอดู ขอสำเนา ขอแก้ไข ขอให้ลบ ขอให้หยุดใช้ หรือถอนความยินยอมได้ทุกเมื่อ และร้องเรียนต่อสำนักงาน คปภ. หรือ สคส. ได้"
          },
          "en": {
            "label": "Your rights",
            "value": "Access, a copy, correction, deletion, restriction, or withdrawal of consent at any time — plus the right to complain to the OIC or the PDPC."
          }
        }
      ]
    },
  ...
  "motorPage": {
    "seo": {
      "title": {
        "th": "ประกันรถยนต์ | CoverMate เทียบเบี้ยจาก 14 บริษัท",
      ...
      "items": [
        {
          "icon": "compare",
          "th": {
            "label": "เทียบจาก 14 บริษัท"
          },
          "en": {
            "label": "14 insurers compared"
          }
        },
        {
          "icon": "check",
    ...
    "cover": {
      ...
      "items": [
        ...
        },
        {
          ...
          "th": {
            "title": "พ.ร.บ.",
            "sub": "ภาคบังคับตามกฎหมาย",
            "b1": "รถทุกคันต้องมีเพื่อใช้ต่อภาษีประจำปี",
            "b2": "คุ้มครองค่ารักษาและเงินชดเชยผู้ประสบภัยตามที่กฎหมายกำหนด",
            "b3": "สามารถออกพร้อมกับประกันภาคสมัครใจในรอบเดียวกันได้"
          },
          "en": {
            "title": "Compulsory (พ.ร.บ.)",
            "sub": "Required by law",
            "b1": "Every car needs this to renew annual road tax.",
            "b2": "Provides statutory medical and injury benefits for accident victims.",
            "b3": "Can be issued together with voluntary motor insurance in the same renewal cycle."
          }
        }
      ]
    }
